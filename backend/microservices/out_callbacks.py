...
class OutCallbackMicroservice(BaseHandler):
    name = "OutCallbackMicroservice"
    with_nats = True
    ...
    async def on_start(self):
        ...
        self.logger.info("OutCallbackMicroservice started")
    ...
    async def on_stop(self):
        ...
        await super().on_stop()
        self.logger.info("OutCallbackMicroservice stopped")
    ...
    async def inner_run(self):
        ...
        self.logger.info("OutCallbackMicroservice inner run started")

            ...
            {[
              ...
              >
                <div style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  background: `linear-gradient(135deg, ${heroShadow}${Math.round(action.opacity * 255).toString(16).padStart(2, '0')}, ${heroShadow}${Math.round(action.opacity * 0.4 * 255).toString(16).padStart(2, '0')})`,
                  color: heroShadow,
                  boxShadow: `0 0 14px ${heroShadow}55`,
